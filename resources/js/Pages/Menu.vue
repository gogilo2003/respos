        ...
        <div class="min-h-screen bg-[#FFE680]">
            <div class="mx-auto max-w-7xl px-4 py-10">
                <div class="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <a href="/"
                            class="inline-flex items-center gap-2 text-lg font-bold text-gray-900 hover:underline"
                ...
                <div v-else class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    <article v-for="item in props.menuItems" :key="item.id ?? item.title"
                        ...
                        <div class="p-4">
                            ...
                            <button
                                class="mt-4 w-full rounded-lg bg-black px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-gray-800 disabled:opacity-60"
                                :disabled="!item.id" @click="addToCart(item)">
                                Add to cart
                            </button>
