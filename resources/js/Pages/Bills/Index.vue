        ...
        result = result.filter(
            (b) =>
                ...
                (b.table?.table_number &&
                    b.table.table_number.toLowerCase().includes(q)),
        );
    }
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        View generated bills, settlement status, and invoice
                        history
                    </p>
                </div>
            </div>
                ...
                >
                    ...
                    >
                        ...
                        <select
                            ...
                            class="w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:w-44"
                        >
                        ...
                        >
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            class="rounded bg-blue-50 px-2.5 py-1 text-xs font-semibold text-blue-800"
                                        >
                                            Table
                                            {{
                                    ...
                                    >
                                        <Link
                                            ...
                                            "
                                            class="mr-4 font-semibold text-indigo-600 hover:text-indigo-900"
                                        >
                                            View Bill →
                                        </Link>
                                        <button
        ...
        <Modal :show="confirmingVoidModal" @close="confirmingVoidModal = false">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Voiding a bill cancels payment processing for bill #{{
                        billToVoid
                    }}. This action requires manager/admin approval.
                </p>
