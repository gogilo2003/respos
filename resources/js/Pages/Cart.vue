    ...
    <WebLayout title="Shopping Cart">
        <div class="min-h-screen px-4 py-8 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-3xl">
                ...
                <div v-if="!cartStore.isEmpty" class="mb-6 rounded-xl border border-gray-200 p-5 shadow-sm">
                    <div v-if="props.activeSession" class="flex items-center justify-between">
                        ...
                        <span class="rounded-full bg-green-100 px-3 py-1 text-xs font-semibold text-green-800">Active
                            Session</span>
                    </div>
                    ...
                    <div v-else class="space-y-2">
                        ...
                        <select id="table_select" v-model="selectedTableId"
