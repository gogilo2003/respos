        ...
        <div class="py-8">
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <div
                        v-if="recent_open_bills.length === 0"
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                class="mt-4 flex items-center justify-between border-t border-gray-100 pt-3 text-xs"
                            >
