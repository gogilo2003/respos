        ...
        <div class="py-8">
            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <!-- Today Sales -->
                    <div
                        class="overflow-hidden rounded-xl border border-gray-100 bg-white p-5 shadow-sm"
                    >
                        <div class="flex items-center justify-between">
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-500"
                                >Kitchen Active Queue</span
                            >
                            <span
                                class="rounded-lg bg-amber-50 p-2 text-amber-600"
                            >
                                🍳
                            </span>
                        </div>
                ...
                <div class="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
                    ...
                    <div
                        class="rounded-xl border border-gray-100 bg-white p-6 shadow-sm lg:col-span-2"
                    >
                    ...
                    >
                        ...
                        <div class="space-y-3">
                            <Link
                                :href="route('users')"
                                class="flex items-center justify-between rounded-lg border border-gray-200 p-3 transition hover:bg-gray-50"
                            >
                            ...
                            >
                                ...
                                <span class="text-xs font-bold text-gray-500"
                                    >{{
                                        statistics.active_categories_count
                                    }}
                                    active</span
                                >
                            </Link>
                            ...
                            >
                                ...
                                <span class="text-xs font-bold text-gray-500"
                                    >{{
                                        statistics.available_items_count
                                    }}
                                    available</span
                                >
                            </Link>
