    ...
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
        <div class="grid grid-cols-1 gap-4 px-4 py-4 sm:grid-cols-3">
            <div>
                ...
                <p class="mt-1 text-lg font-semibold text-gray-900">{{ totalItems }}</p>
            </div>

            <div>
                <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Estimated Prep Time</p>
            ...
            <div class="sm:text-right">
                <p class="text-xs font-medium uppercase tracking-wide text-gray-500">Grand Total</p>
                <p class="mt-1 text-2xl font-bold text-gray-900">{{ grandTotal }}</p>
            </div>
        </div>
    </div>
</template>
