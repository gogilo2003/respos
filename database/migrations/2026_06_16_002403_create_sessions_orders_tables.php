...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('table_sessions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('opened_by', 36)->nullable();
            ...
            $table->unsignedBigInteger('closed_by', 36)->nullable();
        ...
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('placed_by_user', 36)->nullable();
            ...
            $table->unsignedBigInteger('cancelled_by', 36)->nullable();
